...
public class Servicios extends javax.swing.JFrame {
    ...
    public Servicios() {
        ...
        try{
            ...
            ps=con.prepareStatement("SELECT Id, Nombre, Horario, Costo, Estado FROM Servicios");
            rs=ps.executeQuery();
            rsmd=rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Borrar Servicio");
        ...
        jLabel7.setText("Editar Servicio");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Horario", "Costo", "Estado"
            }
        ) {
